...
player = createSprite(displayWidth-950, displayHeight-300, 50, 50);
...
if(keyWentDown("space")){
  bullet = createSprite(displayWidth-1150,player.y-30,35,30)
  bullet.velocityX = 20
...
//destroy zombie, player and bullets and display a message in gameState "bullet"
  ...
  textSize(50)
  fill("yellow")
  text("You ran out of vacciene!!!",470,410)
  zombieGroup.destroyEach();
  player.destroy();
  bulletGroup.destroyEach();
